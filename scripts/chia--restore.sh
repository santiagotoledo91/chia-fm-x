...
DB_CURRENT_FOLDER="${HOME}/chia/.chia/mainnet/db"
DB_CURRENT_FILE="${DB_CURRENT_FOLDER}/blockchain_v2_mainnet.sqlite"
...
echo "$(date) | ${GREEN}-> Clearing db folder${NC}"
rm "${DB_CURRENT_FOLDER}/*"
